        ...
        return (
            <Fragment>
                <div className={classes.Create}>
                    ...
                    <Link className={classes.Link} to="/HomerMap/MapChat" varianat='inherant'>  <MarkerType text='Map chat' pic={chatsvg} /> </Link>

                        <Link to='/HomerMap/Create/BeaconInstruction/steps/0' className={classes.Link}>
                            <MarkerType text='Add Beacon' pic={beaconsvg} function='add_beacon' />
                        </Link>

                        <Link  to='/HomerMap/Create/AddHomeListing' className={classes.Link}>
...
export default withStyles(styles, { withTheme: true })(CreateNavigation);