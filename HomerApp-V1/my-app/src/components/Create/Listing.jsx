...
import {selectRoomType} from '../../actions/postActions'
        ...
        return (
            <Fragment>
                <div style={styles.Create}>
                    ...
                    <Router>
                        <Route exact path='/MapBox/Create/AddHomeListing' >
                            ...
                            <Fragment>
                                ...
                                <div id='beaconInstruction' style={styles.beaconInstructionsBtnDiv}>
                                    ...
                                    <Link to='/MapBox/Create/AddHomeListing/1' style={{ color: 'inherit', textDecoration: 'inherit' }}>
                        ...
                        <LiveRoute path='/MapBox/Create/AddHomeListing/1' >
                            <div>
                                <p>{this.state.instruction_1.text}</p>
                                <Link to='/MapBox/Create/AddHomeListing/2' style={{ color: 'inherit', textDecoration: 'inherit' }}> <button>Next</button></Link>

                            </div>
                        </LiveRoute>

                        <Route path='/MapBox/Create/AddHomeListing/2' >
                            <div>
                                <p>{this.state.instruction_2.text}</p>
                                <Link to='/MapBox/Create/AddHomeListing/3' style={{ color: 'inherit', textDecoration: 'inherit' }}><button>Next</button></Link>

                            </div>
                        </Route>

                        <Route path='/MapBox/Create/AddHomeListing/3'>
                            <Fragment>
                                ...
                                <Link to='/MapBox/Create/AddHomeListing/UploadDraggableBox'><button>next</button></Link>

                            </Fragment>
                        </Route >

                        <Route path='/MapBox/Create/AddHomeListing/UploadDraggableBox'>
                    ...
                    <Fragment>
                        ...
                        <Link to='/MapBox' style={{ color: 'inherit', textDecoration: 'inherit' }}><span style={styles.closeBtn}>CLOSE to cancel</span></Link>
...
export default connect(null,{selectRoomType})(Listing)