...
We have organizational values and personal values, and are working on our shared values with design and product. However, when we
make decisions on what and how to do engineering, we need guiding principles. These are the things that make
Homer's development culture unique and that drive us to do great work.


### Open Source by Default

We consider that our data and relationships with the world of homes makes Homer a difficult business to copy. Our source
...
Working in the open allows individual to retain their work and ideas post-Homer. We can share the exact problems we
...
**must** feel safe asking questions and discussing mistakes. Everyone in Homer Engineering, but especially those in
...
Behind every piece of code is a human, internal or external to Homer. Give people the benefit of the doubt and
...
- A regular meetup could be converted into a system for others to replicate

The small improvements eventually add up so that you can do industry-impact work as a part of building Homer.
...
- Examples
  ...
  - Teach Swift via Swift at Homer
...
[readme]: https://github.com/domomi/homer/README
