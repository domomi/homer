...
export default function TransitionsModal(props) {
  ...
  const updateRenterFilter = () => {
    ...
    $.ajax({
      type: "POST",
      url: `${process.env.REACT_APP_EXPRESS_ENDPOINT}/UpdateHomeOwnerListingProperties`,
      data: data,
      dataType: "text",
      ...
      >
        <Fade in={open}>
          <div className={classes.paper}>
            ...
            <h2 id="transition-modal-title">Please configure your Listing </h2>
            <p id="transition-modal-description">For better Explosure.</p>

            {/* Will not use the default action */}
            <form className={classes.filterForm} action={`${process.env.REACT_APP_EXPRESS_ENDPOINT}/UpdateHomeOwnerListingProperties`} method='post'>
