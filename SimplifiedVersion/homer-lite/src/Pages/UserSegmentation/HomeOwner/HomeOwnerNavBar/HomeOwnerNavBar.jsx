...
export default function BottomNavBar() {
    ...
    const viewDetails = (updated_time) => {
        ...
        //     type: "POST",
        //     // url: `${process.env.REACT_APP_EXPRESS_ENDPOINT}/fetchUserAlerts`,
        //     url: `${process.env.REACT_APP_EXPRESS_ENDPOINT}/viewDetails`,
        //     data: data,
        //     dataType: "json",
        //     success: function (alert_arr) {
        //         // alert array:
                        ...
                        <div>
                            ...
                            {alertEls.map((item, idx) => {
                                return (<div className={classes.AlertItems}>
                                    ...
                                    <Button variant='outlined' color='secondary' onClick={visitThePosition(item.listing_location)}>Visit The Position</Button>
                                    <Link style={{textDecoration : 'none'}} to='/ViewPosts'> <Button variant='contained' color='primary' onClick={viewDetails(item.update_time)} > View Details</Button></Link>
                                </div>
