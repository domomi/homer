        ...
        return (
            <Fragment>
                ...
                <div id='mobile-scroll' className={classes.mobileScroll}>
                    ...
                    <div id='choices-home-left' className={classes.choiceDiv}>
                        <p>Townhomes</p>
                        <p>Detached-homes</p>
                    ...
                    <div id='choices-home-right' className={classes.choiceDiv}>
                ...
                <div id='nextBtnDiv' style={{ textAlign: 'center' }}>
                    <Button className={classes.nextBtn} color='secondary' variant='contained' onClick={() => this.handleNext()} >Next</Button>
                </div>
