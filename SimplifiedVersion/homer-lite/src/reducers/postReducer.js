import { 
    ...
    // Update the Home Owner Status from the pages
    UPDATE_HOME_OWNER_MAP_STATUS,

    // Get status from the database
    FETCH_HOME_OWNER_MAP_STATUS,
...
const initialState = {
    ...
    // Mapped to props of HomeOwnerMap > BottomCardStep_1
    home_owner_map_config_step : 1
...
export default function (state = initialState, action) {
    switch (action.type) {
        ...
        case UPDATE_HOME_OWNER_MAP_STATUS : {
            console.log(action.payload)
            console.log(UPDATE_HOME_OWNER_MAP_STATUS)
        ...
        case FETCH_HOME_OWNER_MAP_STATUS : {
            console.log(FETCH_HOME_OWNER_MAP_STATUS)
            // console.log(action.payload)
            let home_owner_map_config_step = action.payload.home_owner_map_config_step
        ...
        case UPDATE_DESCRIPTION : {
            ...
            let listing_description = action.payload.listing_description
            let user_email = action.payload.user_email
